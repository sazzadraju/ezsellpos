...
function add_delivery() {
    ...
    if(cus){
        ...
        $('#alert_text').html('<span class="glyphicon glyphicon-warning-sign"></span> Please select customer first.');
    }
}
