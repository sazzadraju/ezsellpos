                    ...
                    <div class="full-box element-box">
                        <div class="row"> 
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-3 col-sm-12">
                                <div class="form-group row">
                                    <label class="col-sm-12 col-form-label"><?= lang("stock_type"); ?></label>
                                    <div class="col-sm-12">
                                        <select class="select2" id="stock_type" name="stock_type">
                                            <option value="0" selected><?= lang("select_one"); ?></option>
                                            <option value="13">General Stock Out</option>
                                            <option value="6">Supplier Return</option>
                                            <option value="7">Stock Transfer Send</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-12">
                               <div class="form-group row">
                                   <label class="col-sm-12 col-form-label"><?= lang("stock_out_reason"); ?></label>
                                   <div class="col-sm-12">
                                       <!-- <div class="row-fluid"> -->
                           ...
                           <div class="col-md-3 col-sm-12">
                            ...
                            <div class="col-md-12 col-sm-4">
                                ...
                                <button href="<?php echo base_url(); ?>stock_report/print_page"
                                    class="btn btn-primary pull-right" type="button" onclick="print_data()"><i
...
function searchFilter(page_num) {
   ...
   if ($err_count == 1)  {
    $.ajax({
        type: 'POST',
        url: '<?php echo base_url(); ?>stock-out-report/page-data/' + page_num,
        data: 'page=' + page_num + '&reason=' + reason + '&product_name=' + product_name + '&store_id=' + store_id + '&FromDate=' + FromDate + '&ToDate=' + ToDate+ '&stock_type=' + stock_type+ '&batch_no=' + batch_no,
        beforeSend: function () {
            $('.loading').show();
        },
...
function print_data(page_num) {
   ...
   if ($err_count == 1)  {
    $.ajax({
        type: 'POST',
        url: '<?php echo base_url(); ?>reports/stock_out_report/print_data',
        data: 'reason=' + reason + '&product_name=' + product_name + '&store_id=' + store_id + '&FromDate=' + FromDate + '&ToDate=' + ToDate+ '&stock_type=' + stock_type+ '&batch_no=' + batch_no,
        beforeSend: function () {
            $('.loading').show();
        },
        success: function (html) {
...
function csv_export() {
      ...
      if ($err_count == 1) {
          $.ajax({
              type: 'POST',
              url: '<?php echo base_url(); ?>reports/stock_out_report/create_csv_data',
