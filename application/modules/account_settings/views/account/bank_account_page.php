                                                    ...
                                                    if (!empty($bank_accounts)):
                                                        ...
                                                        foreach ($bank_accounts as $acc):
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php echo $acc['bank_branch']; ?></td>
                                                                ...
                                                                <td class="center fit">
                                                                    <button rel="tooltip" title="<?= lang("view") ?>" class="btn btn-success btn-xs" data-title="<?= lang("view"); ?>" data-toggle="modal" data-target="#ba_view" onclick="viewDetaitls('<?= $acc['id'] ?>')"><span class="glyphicon glyphicon-eye-open"></span></button>
