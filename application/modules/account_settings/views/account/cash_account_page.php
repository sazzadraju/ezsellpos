                                                    ...
                                                    if (!empty($cash_accounts)):
                                                        ...
                                                        foreach ($cash_accounts as $acc):
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="center fit">
                                                                    <button rel="tooltip" title="<?= lang("view") ?>" class="btn btn-success btn-xs" data-title="<?= lang("view"); ?>" data-toggle="modal" data-target="#ca_view" onclick="viewDetaitls('<?= $acc['id'] ?>')"><span class="glyphicon glyphicon-eye-open"></span></button>
