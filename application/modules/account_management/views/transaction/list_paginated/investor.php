    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="element-header margin-0"><?= lang("investor_trx_details"); ?> <span class="close" data-dismiss="modal">&times;</span></h6>
            </div>
...
$(document).on('click', '.invoiceView', function () {
    ...
    var w = window.open('<?php echo base_url().'transactions/investor_print_invoice';?>/'+oId,'name','width=800,height=500', '_blank');
    w.print({
        globalStyles: false,
        mediaPrint: true,
...
function viewDetaitls(id) {
    $.ajax({
        url: "<?php echo base_url() ?>account-management/investor-trx-details/" + id,
        type: "GET",
        beforeSend: function () {
            $('.loading').show();
        },
