...
<div class="form-group row">
    ...
    <div class="col-md-8" id=""><?php echo $supplier_name;?></div>
</div>
<?php
$pay_total=0;
foreach ($payment as $key): ?>
    <div class="form-group row">
        <label class="col-sm-4 col-form-label"><?= $key['type_name']?></label>
        <div class="col-md-8" id=""><?php echo comma_seperator($key['tot_amount']);?></div>
    </div>
<?php
...
<div class="form-group row">
    ...
    <div class="col-md-8" id=""><?php echo set_currency(comma_seperator($pay_total));?></div>
</div>
