               ...
               ?>
                ...
                <div class="in-from-to">
                    ...
                    <div style="width: 35%; float: left;text-align: left;">
                        <ul class="info">
                            <li><span>Transaction Type:</span> <?= get_key($qty_multipliers, $qty_multiplier) ?></li>
                    ...
                    <div style="width: 35%; float: left;text-align: left;">
                        <ul class="info">
                            <li><span>Supplier Id:</span> <?= $supplier_code ?></li>
                            <li><span>Name:</span> <?= $supplier_name ?></li>
                    ...
                    <div class="table-right">
                        <table id="products" border="1">
                            <tr>
                                ...
                                <td style="text-align: right"><span class="bold"><?php echo comma_seperator($total);?></span></td>
                            </tr>
                            <?php
                            $pay_total=0;
                            foreach ($payment as $key): ?>
                            <tr>
                                <td style="text-align: right"><span class="bold"><?= $key['type_name']?></span></td>
                                <td style="text-align: right"><span class="bold"><?php echo comma_seperator($key['tot_amount']);?></span></td>
                            </tr><?php
                            $pay_total+=$key['tot_amount'];
                            $count++;
                            endforeach;?>
