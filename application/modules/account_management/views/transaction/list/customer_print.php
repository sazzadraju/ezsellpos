            ...
            <div class="invoice">
               ...
               ?>
                ...
                <div class="in-from-to">
                    <div class="from-inf">
                        <h3>Transaction No: <?= $invoices[0]['trx_no'] ?></h3>
                        <?php
                        $img = $this->barcode->code128BarCode($invoices[0]['trx_no'], 1);
                        ob_start();
                        imagepng($img);
                        ...
                        <span class="date-time">
                            <?= nice_datetime($invoices[0]['dtt_trx']) ?>
                        </span>
                    </div>
                    <div style="width: 35%; float: left;text-align: left;">
                        <ul class="info">
                            <li><span>Store:</span> <?= $invoices[0]['store_name'] ?></li>
                            <li><span>Address:</span> <?= $invoices[0]['address_line'] ?></li>
                            <li><span>Received By:</span> <?= $invoices[0]['fullname'] ?></li>
                        </ul>
                    </div>
                    <div style="width: 35%; float: left;text-align: left;">
                        <ul class="info">
                            <li><span>Customar ID:</span> <?= $invoices[0]['customer_code'] ?></li>
                            <li><span>Name:</span> <?= $invoices[0]['customer_name'] ?></li>
                            <li><span>Phone:</span> <?= $invoices[0]['customer_mobile'] ?></li>
                        </ul>
                    </div>
                </div>
                    ...
                    <table id="products" border="1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="right"><?php echo comma_seperator($item['amount']); ?></td>
                            </tr><?php
                            $count++;
                            endforeach;?>
                        </tbody>
                    ...
                    <div class="table-right">
                        <table id="products" border="1">
                            ...
                            <tr>
                                ...
                                <td style="text-align: right"><span class="bold"><?php echo get_val($payment_details[0]['account_name']);?></span></td>
                            </tr>
                            <tr>
                                <td style="text-align: right"><span class="bold"><?= lang('payment_method'); ?></span></td>
                                <td style="text-align: right"><span class="bold"><?php echo get_key($this->config->item('trx_payment_mehtods'), $payment_details[0]['payment_method_id']);?></span></td>
                            </tr>
                            <?php if($payment_details[0]['payment_method_id']==4):?>
                                <tr>
                                    <td style="text-align: right"><span class="bold"><?= lang('bank'); ?></span></td>
                                    <td style="text-align: right"><span class="bold"><?php echo get_key($general_banks, $payment_details[0]['ref_bank_id']);?></span></td>
                                </tr>
                            <?php endif;?>
                            ...
                            <?php if($payment_details[0]['payment_method_id']==2):?>
                                <tr>
                                    ...
                                    <td style="text-align: right"><span class="bold"><?php echo get_key($cards, $payment_details[0]['ref_card_id']);?></span></td>
                                </tr>
                            <?php endif;?>
                            <?php if($payment_details[0]['payment_method_id']==2 || $payment_details[0]['payment_method_id']==3 || $payment_details[0]['payment_method_id']==4):?>
                                    ...
                                    <td style="text-align: right"><span class="bold"><?php echo get_val($payment_details[0]['ref_acc_no']);?></span></td>
                                </tr>
                            <?php endif;?>
                            <?php if($payment_details[0]['payment_method_id']==2 || $payment_details[0]['payment_method_id']==3):?>
                                <tr>
                                    ...
                                    <td style="text-align: right"><span class="bold"><?php echo get_val($payment_details[0]['ref_trx_no']);?></span></td>
                                </tr>
                            <?php endif;?>
                        </table>
                    </div>
