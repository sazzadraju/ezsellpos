               ...
               ?>
                ...
                <div class="in-from-to">
                    ...
                    <div style="width: 35%; float: left;text-align: left;">
                        <ul class="info">
                            <li><span>Transaction Type:</span> <?php echo $qty_multipliers[$qty_multiplier]; ?></li>
                ...
                <br>
                    <table id="products" border="1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="fit center"><?php echo $count; ?>.</td>
                                <td class=""><?php echo $trx_no; ?></td>
                                <td class=""><?php echo $category.'/'.$sub_category; ?></td>
