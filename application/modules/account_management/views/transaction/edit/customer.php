                            ...
                            <form class="form-horizontal" role="form" id="frm_trx_customer" action="" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-md-7">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                            <?php echo $full_name;?>
                                            <input type="hidden" name="customer_id" id="customer_id" value="<?php echo $this->commonlib->encrypt_srting($customer_id);?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                            <input class="form-control" type="text" name="tot_amount" id="tot_amount" value="<?php echo $tot_amount; ?>" onkeypress="return amountInpt(this, event);">
                                            <label id="tot_amount-error" class="error" for="tot_amount"></label>
                                            <input type="hidden" name="old_paid_amt" id="old_paid_amt" value="<?php echo $tot_amount;?>" />
                                        </div>
                                    </div>

                                    <?php if(isset($trx_details)):?>
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label"><?= lang('payment_details'); ?> <span class="req">*</span></label>
                                        <div class="col-md-8" id="">
                                            <table id="bank_acc_tbl" class="table table-bordred table-striped">
                                                <thead>
                                                    <th class="fit"><?= lang("sl_no"); ?></th>
                                                    <th class="fit"><?= lang("invoice_no"); ?></th>
                                                    <th class="fit text-right"><?= lang("due"); ?></th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="fit"><?php echo $item['invoice_no']; ?></td>
                                                        <td class="fit text-right"><?php echo round_to_2dp($item['amount']+$item['due_amt']); ?></td>
                                                        <td class="fit text-right">
                                                            <input class="form-control text-right pay_amt_cls" type="text" name="pay_amt[]" id="pay_amt_<?=$count;?>" value="<?php echo $item['amount'];?>" onkeypress="return amountInpt(this,event);">
                                                            <input type="hidden" name="param[]" id="param_<?=$count;?>" value="<?php echo $item['params'];?>" />
                                                            <?php
                                                            $tot_amt += $item['amount'];
                                                        ?></td>
                                                    </tr><?php
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" readonly class="form-control text-right" name="pay_amt_tot" id="pay_amt_tot" value="<?php echo round_to_2dp($tot_amt);?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                            <div class='input-group date' id='dtt_trx'>
                                                <input type='text' class="form-control" id="dtt_trx" name="dtt_trx" value="<?php echo $dtt_trx; ?>" />
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="row-fluid">
                                                <select class="form-control" id="account" name="account">
                                                    ...
                                                    if ($accounts) :
                                                        foreach ($accounts as $account) :
                                                            if($payment_details[0]['account_id']==$account['acc_id']){
                                                                $acc_val=$account['curr_balance'];
                                                            }
                                                            ?>
                                                        <option actp="<?php echo $account['acc_type']; ?>" value="<?php echo $account['acc_id']; ?>" <?php if($payment_details[0]['account_id']==$account['acc_id']):?> selected<?php endif;?>>
                                                ...
                                                <input type="hidden" id="h_pay_method" name="h_pay_method" value="<?php echo $payment_details[0]['payment_method_id'];?>" />
                                                <label id="account-error" class="error" for="account"></label>
                                            </div>
                                        </div>
                                    </div>
                                    
                                    <div class="form-group row" id="v_pay_method" <?php if($payment_details[0]['acc_type_id']!=1):?>style="display:none;"<?php endif;?>>
                                        <label class="col-sm-4 col-form-label"><?= lang('payment_method') ?> <span class="req">*</span></label>
                                        <div class="col-md-8">
                                            <div class="row-fluid">
                                                <select class="select2" data-live-search="true" id="pay_method" name="pay_method">
                                                    <option value="0"><?= lang('select_one') ?></option>
                                                    <?php foreach ($this->config->item('trx_payment_mehtods_by_bank') as $key=>$val) : ?>
                                                    <option value="<?php echo $key;?>" <?php if($key==$payment_details[0]['payment_method_id']):?> selected<?php endif;?>><?php echo $val; ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                    ...
                                    <?php 
                                    $display = false;
                                    if($payment_details[0]['payment_method_id']==4){
                                        $display = true;
                                    }?>
                                    <div class="form-group row" id="v_ref_bank" <?php if(!$display):?>style="display:none;"<?php endif;?>>
                                        <label class="col-sm-4 col-form-label"><?= lang('bank') ?></label>
                                        <div class="col-md-8">
                                            <div class="row-fluid">
                                                <select class="select2" data-live-search="true" id="ref_bank" name="ref_bank">
                                                    <option value="0"><?= lang('select_one') ?></option>
                                                    <?php foreach ($general_banks as $key=>$val) : ?>
                                                        <option value="<?php echo $key;?>" <?php if($key==$payment_details[0]['ref_bank_id']):?> selected<?php endif;?>><?php echo $val; ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                    ...
                                    <div class="form-group row" id="v_ref_mobile_bank" style="display:none;">
                                        ...
                                        <div class="col-md-8">
                                            <div class="row-fluid">
                                                <select class="select2" data-live-search="true" id="ref_mobile_bank" name="ref_mobile_bank">
                                                    <option value="0"><?= lang('select_one') ?></option>
                                    ...
                                    <?php 
                                    $display = false;
                                    if($payment_details[0]['payment_method_id']==2){
                                        $display = true;
                                    }?>
                                    <div class="form-group row" id="v_ref_card" <?php if(!$display):?>style="display:none;"<?php endif;?>>
                                            ...
                                            <div class="row-fluid">
                                                <select class="select2" data-live-search="true" id="ref_card" name="ref_card">
                                                    ...
                                                    <?php foreach ($cards as $key=>$val) : ?>
                                                        <option value="<?php echo $key;?>" <?php if($key==$payment_details[0]['ref_card_id']):?> selected<?php endif;?>><?php echo $val; ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                    ...
                                    <?php 
                                    $display = false;
                                    if((in_array($payment_details[0]['payment_method_id'], [2,4])) 
                                        // || $payment_details[0]['acc_type_id']==3
                                        ){
                                        $display = true;
                                    }?>
                                    <div class="form-group row" id="v_ref_acc_no" <?php if(!$display):?>style="display:none;"<?php endif;?>>
                                        <label class="col-sm-4 col-form-label"><?= lang('account_card_no'); ?></label>
                                        <div class="col-md-8">
                                            <input class="form-control" type="text" name="ref_acc_no" id="ref_acc_no" value="<?=$payment_details[0]['ref_acc_no'];?>">
                                    ...
                                    <div class="form-group row" id="v_ref_trx_no" <?php if(!$display):?>style="display:none;"<?php endif;?>>
                                        <label class="col-sm-4 col-form-label"><?= lang('ref_trx_no'); ?></label>
                                        <div class="col-md-8">
                                            <input class="form-control" type="text" name="ref_trx_no" id="ref_trx_no" value="<?=$payment_details[0]['ref_trx_no'];?>">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <fieldset class="form-group">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control" placeholder="<?= lang('name') ?>" type="text" name="document_name" id="document_name" value="<?= $d_name?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label"><?= lang('description') ?></label>
                                            <div class="col-sm-8">
                                                <textarea class="form-control" rows="3" name="document_description" id="document_description"><?= $d_description?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer ">
                ...
                <button type="button" class="btn btn-success" onclick="delete_doc();"><span class="glyphicon glyphicon-ok-sign"></span> <?= lang("yes"); ?></button>
...
<script>
    ...
    $("#frm_trx_customer").submit(function () {
        if (validate_data() != false) {
            ...
            $.ajax({
                type: "POST",
                url: '<?php echo base_url();?>account-management/edit-customer-trx/<?php echo $this->commonlib->encrypt_srting($id);?>',
                data: data_string,
                async: false,
                beforeSend: function () {
                    $('.loading').show();
