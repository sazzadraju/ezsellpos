            ...
            <div class="col-lg-12">
                <div class="element-wrapper">
                    <div class="element-box full-box">
                        ...
                        <!-- MAIN BODY STARTS-->
                        <div class="row">
                            <form class="form-horizontal" role="form" id="frm_trx_emp" action="" method="POST" enctype="multipart/form-data">
                                <!-- LEFT SIDE STARTS -->
                                <div class="col-md-7">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label"><?= lang('employee'); ?></label>
                                        <div class="col-md-8">
                                            <?=$employee_name;?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label"><?php echo get_key($qty_multipliers, $qty_multiplier);?> </label>
                                        <div class="col-md-8">
                                            <?=$trx_name;?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                            <textarea class="form-control" rows="3" name="description" id="description" value="description"><?=$description;?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                            <input class="form-control" type="text" name="tot_amount" id="tot_amount" value="<?=$tot_amount;?>" onkeypress="return amountInpt(this, event);">
...
<script>
    ...
    function validate_data() {
        ...
        if(qmv == '-1' && $('input[name=tt_payment]').val()=='0'){
        ...
        if(qmv == '1' && $('input[name=tt_return]').val()=='0'){
    ...
    $("#frm_trx_emp").submit(function () {
        if (validate_data() != false) {
            var data_string = new FormData($(this)[0]);
            
            $.ajax({
                type: "POST",
                url: '<?php echo base_url(); ?>account-management/edit-employee-trx/<?php echo $this->commonlib->encrypt_srting($id);?>',
                data: data_string,
                async: false,
                beforeSend: function () {
                    $('.loading').show();
