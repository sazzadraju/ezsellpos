                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                            <div class='input-group date' id='dtt_trx'>
                                                <input type='text' class="form-control" id="dtt_trx" name="dtt_trx" value="<?php echo $transaction_date; ?>" />
...
<script>
    ...
    $("#frm_trx_office").submit(function () {
        if (validate_data() != false) {
            ...
            $.ajax({
                type: "POST",
                url: '<?php echo base_url(); ?>account-management/edit-investor-trx/<?php echo $this->commonlib->encrypt_srting($id);?>',
                data: data_string,
                async: false,
                beforeSend: function () {
                    $('.loading').show();
