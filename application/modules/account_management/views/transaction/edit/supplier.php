            ...
            <div class="col-lg-12">
                <div class="element-wrapper">
                    <div class="element-box full-box">
                        ...
                        <!-- MAIN BODY STARTS-->
                        <div class="row">
                            <form class="form-horizontal" role="form" id="frm_trx_supplier" action="" method="POST" enctype="multipart/form-data">
                                <!-- LEFT SIDE STARTS -->
                                <div class="col-md-7">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label"><?= lang('supplier'); ?> <span class="req">*</span></label>
                                        <div class="col-md-8">
                                            <?=$supplier_name;?>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label"><?= lang('amount_pay'); ?> <span class="req">*</span></label>
                                        <div class="col-md-8">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="row-fluid">
                                                <select class="select2" data-live-search="true" id="account" name="account">
                                                    ...
                                                    if ($accounts) :
                                                        foreach ($accounts as $account) :
                                                            ...
                                                            ?>
                                                        <option actp="<?php echo $account['acc_type']; ?>" value="<?php echo $account['acc_id']; ?>" <?php if($account_id==$account['acc_id']):?> selected<?php endif;?>>
                                                ...
                                                <input type="hidden" id="h_pay_method" name="h_pay_method" value="<?php echo $payment_method_id;?>" />
                                                <label id="account-error" class="error" for="account"></label>
                                            </div>
                                        </div>
                                    </div>

                                    <div class="form-group row" id="v_pay_method" <?php if($acc_type_id!=1):?>style="display:none;"<?php endif;?>>
                                        ...
                                        <div class="col-md-8">
                                            <div class="row-fluid">
                                                <select class="select2" data-live-search="true" id="pay_method" name="pay_method">
                                                    ...
                                                    <option value="<?php echo $key;?>" <?php if($key==$payment_method_id):?> selected<?php endif;?>><?php echo $val; ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            ...
                                            <div class="row-fluid">
                                                <select class="select2" data-live-search="true" id="ref_bank" name="ref_bank">
                                                    ...
                                                    <?php foreach ($general_banks as $key=>$val) : ?>
                                                        <option value="<?php echo $key;?>" <?php if($key==$ref_bank_id):?> selected<?php endif;?>><?php echo $val; ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            ...
                                            <div class="row-fluid">
                                                <select class="select2" data-live-search="true" id="ref_card" name="ref_card">
                                                    ...
                                                    <?php foreach ($cards as $key=>$val) : ?>
                                                        <option value="<?php echo $key;?>" <?php if($key==$ref_card_id):?> selected<?php endif;?>><?php echo $val; ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                    ...
                                    <div class="form-group row" id="v_ref_acc_no" <?php if(!$display):?>style="display:none;"<?php endif;?>>
                                        ...
                                        <div class="col-md-8">
                                            <input class="form-control" type="text" name="ref_acc_no" id="ref_acc_no" value="<?=$ref_acc_no;?>">
                                    ...
                                    <div class="form-group row" id="v_ref_trx_no" <?php if(!$display):?>style="display:none;"<?php endif;?>>
                                        ...
                                        <div class="col-md-8">
                                            <input class="form-control" type="text" name="ref_trx_no" id="ref_trx_no" value="<?=$ref_trx_no;?>">
...
<script>
    ...
    $("#frm_trx_supplier").submit(function () {
        if (validate_data() != false) {
            ...
            $.ajax({
                type: "POST",
                url: '<?php echo base_url(); ?>account-management/edit-supplier-trx/<?php echo $this->commonlib->encrypt_srting($id);?>',
                data: data_string,
                async: false,
                beforeSend: function () {
                    $('.loading').show();
