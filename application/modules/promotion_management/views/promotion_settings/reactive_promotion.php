            ...
            <div class="col-lg-12">
                <div class="element-wrapper">
                    <div class="top-btn full-box">
                        <div class="row">
                            <form role="form" id="enter_promotion" action="" method="POST" enctype="multipart/form-data">
                               ...
                               <input type="hidden" id="promotion_id" name="promotion_id" value="<?php echo $promotional_data[0]['id_promotion'];?>">
                                <div class="col-md-3 col-sm-12">
                                    <div class="form-group row">
                                        ...
                                        <label class="col-sm-12 col-form-label" for=""><?php echo $this->lang->line('promotion_type');?></label>
                                        <div class="col-sm-12">
                                            <div class="row-fluid">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="input-group date" id="validate_from">
                                                    <input type="text" class="form-control" id="dt_from" name="dt_from" value="<?php echo $promotional_data[0]['dt_from'];?>">
...
<script>
    ...
    function validate_promotion_enter() {
        ...
        var promotion_on = $("input[name=edit_promotion_on]").val();
        ...
        // if (type_id == 0 || title == "" || inDateStr == "" || endDateStr == "" || end_date < in_date || purchase_amt_from == "" || !($.isNumeric(purchase_amt_from)) || discount_amount == "" || !($.isNumeric(discount_amount)) || check_pomotion == 0) {
    ...
    $("#enter_promotion").submit(function () {
        if (validate_promotion_enter() != false) {
            ...
            $.ajax({
                type: "POST",
                url: '<?php echo base_url(); ?>enter_reactive_promotion',
                data: dataString,
                async: false,
                beforeSend: function () {
                    $('.loading').show();
    ...
    $(document).on('input', '.change_value', function () {
        ...
        var name=this.name;
        //var qty = $("#qty_" + id).val();
        var selling_price = $("#selling_price_" + id).val()*1;
         if(name=='percet[]'){
