            ...
            <div class="invoice">
               ...
               ?>
                ...
                <div class="in-from-to">
                    <div class="from-inf">
                        <h3><?= lang("quotation_no"); ?>: <?= $qMaster[0]['quotation_no'] ?></h3>
                        <?php
                        $img = $this->barcode->code128BarCode($qMaster[0]['quotation_no'], 1);
                        ob_start();
                        imagepng($img);
                        ...
                        <span class="date-time">
                            <?= nice_datetime($qMaster[0]['dtt_add']) ?>
                        </span>
                    </div>
                    ...
                    <div style="width: 35%; float: left;text-align: left;">
                        <ul class="info">
                            <li><span>Customar ID:</span> <?= $qMaster[0]['full_name'] ?></li>
                            <li><span>Name:</span> <?= $qMaster[0]['email'] ?></li>
                            <li><span>Phone:</span> <?= $qMaster[0]['phone'] ?></li>
                            <li><span>Receive By:</span> <?php print_r($sellerName); ?></li>
                        </ul>
                    </div>
                </div>
                <br>
                ...
                <table id="products" border="1">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo $aDetail['selling_price'];?>
                            </td>
                            <td>
                                <?php echo $aDetail['discount_amt'];?>
                ...
                <div class="table-break">
                    <div class="table-left">
                        <?php
                        $description='<div class="sales-person"><span class="bold">'.lang('note').'</span>:'. $qMaster[0]['note'].'</div>';
                        echo  $description ;
                        ?>
                    </div>
                    <div class="table-right">
                        <table id="products" border="1">
                            <tr>
                                <td style="text-align: right"><span class="bold"><?= lang('sub_total') ?></span></td>
                                <td style="text-align: right"><span class="bold"><?php echo comma_seperator($qMaster[0]['product_amt']);?></span></td>
                            </tr>
                            <tr>
                                <td style="text-align: right"><span class="bold"><?= lang('discount') ?></span></td>
                                <td style="text-align: right"><span class="bold"><?php echo comma_seperator($qMaster[0]['discount_amt']);?></span></td>
                            </tr>
                            <tr>
                                <td style="text-align: right"><span class="bold"><?= lang('total') ?></span></td>
                                <td style="text-align: right"><span class="bold"><?php echo comma_seperator($qMaster[0]['total_amt']);?></span></td>
                            </tr>
