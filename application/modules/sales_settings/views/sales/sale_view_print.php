    ...
    <div class="middle-content">
        ...
        <div class="bill">
            ...
            <div class="cus-info">
                ...
                <?php if(isset($customers)){
                    echo $customers[0]['customer_code'].'/'.$customers[0]['full_name'];
                }?></p>
            </div>
            <p class="invoice-no">
                Invoice: <?= $invoice ?>
        ...
        <div class="table-content">
            <table class="sale_view_table" cellspacing="0" cellpadding="0" border="1">
                ...
                <tr>
                    ...
                    <th class="center" width="12%">Dis</th>
                    <th class="center" width="12%">Qty</th>
                    <th class="center" width="12%">Vat</th>
                    <th class="right_align" width="18%">Total(<?=set_currency()?>)</th>
                </tr>
                <?php
                $i = 1;
                $sum = 0;
        ...
        <div class="summury1">
            <div class="adjustment">
                ...
                <p style="font-weight:bold;margin:0;">Round: <span><?= $round_amt ?></span></p>
                <table class="table-pay-type" cellspacing="0" cellpadding="0" border="1">
                    ...
                    if (isset($replace_amount)) {
                        echo '<tr><td>Replace Amount</td><td>' . floatVal($replace_amount) . ' </td></tr>';
                ...
                <div class="prd">
                    <p style="font-weight:bold;border-bottom: 1px solid #000;font-size: 14px;">Total Paid:
                        <span><?= floatVal($all_paid_amt) ?> </span></p>
                    <?php
