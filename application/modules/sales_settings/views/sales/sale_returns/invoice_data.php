            ...
            <table id="addSection" class="table table-bordred table-striped">
                ...
                foreach ($posts as $post) {
                    ...
                    <tr>
                        ...
                        <td><?= $post->batch_no ?></td>
                        <td align="center"><?= $post->qty ?> <input type="hidden" name="qty[]" id="qty_<?= $count ?>" value="<?=$post->qty ?>"></td>
                        <td align="center">
                            <?php
                            if(!empty($returns)) {
                                foreach ($returns as $return) {
                                    if($return['stock_id']==$post->stock_id){
                                        echo $return['rtn_qty'];
                                        echo '<input type="hidden" name="rtn_qty[]" id="rtn_qty_'. $count.'"value="'. $return['rtn_qty'].'">';
                                        break;
                                    }
                                }
                            }else{
