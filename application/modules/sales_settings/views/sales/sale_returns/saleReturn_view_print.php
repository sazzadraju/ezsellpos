...
//print_r($stores);
    ...
    <div class="invoice_content">
                ...
                <div class="adjustment">
                    ...
                    if ($promotions) {
                        foreach ($promotions as $promotion) {
                            ...
                            echo '<p>' . $promo[$type] . ' (-) ' . $promotion->discount_rate . '%  <span>' . set_currency(number_format($dis_amt,2)) . '</span></p>';
                            $all_dis += $dis_amt;
                        }
                    }
                    ?>
                ...
                <div class="adjustment">
                    ...
                    <div class="prd">
                        <p style="font-weight:bold;border-bottom: 1px solid #000;font-size: 14px;">Return Amount:
                            <span><?= set_currency($invoices[0]['tot_amt']) ?> </span></p>
                    </div>
                </div>
            </div>
            <div class="">
        ...
        <div class="foot">
            ...
            <p>Software Developed By: www.ezellbd.com</p>
        </div>
    </div>
    <?php
}
