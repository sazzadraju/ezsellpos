    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="element-header margin-0"><?= lang('customer') ?> <span class="close" data-dismiss="modal">&times;</span>
                </h6>
            </div>
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (result.status != 'success') {
                        ...
                        if (result.id) {
                            $("#customer").append('<option data-icon="glyphicon glyphicon-user" style="font-size: 11px" actp="'+result.name+ '" value=' + result.id + '>' +result.code+' '+ result.name + ' (' + result.phone + ')</option>').selectpicker('refresh');
                        }
