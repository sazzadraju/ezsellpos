    ...
    function add_cart_discount(ele) {
        ...
        if (val != 0) {
            ...
            if (chk_dis) {
                ...
                var div = '<div id="card"><strong>Card Dis. <b id="cart_dis">' + val_data + '</b>%:</strong><span id="cart_dis_total"> 00</span>&nbsp;TK</div>';
                    ...
                    if ($product.purchase_dis.length > 0) {
                        ...
                        if (purchase_val || purchase_val_taka) {
                            ...
                            if (pur_dis_per.trim()) {
                                ...
                                var div = '<div><strong>Pur. Dis. ' + prch_test + ':</strong><span id="pur_dis_total"> ' + pur_dis_amount + '</span>&nbsp;TK</div>';
                                $('#all_discount').append(div);
                            }
        ...
        if ($name == '') {
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    var div = '<div><strong>Cus. Dis. <b id="cus_dis">' + Number(data[0].discount) + '</b>%:</strong><span id="cus_dis_total"> 00</span>&nbsp;TK</div>';
                    $('#all_discount').append(div);
                    totalCalculation();
                    $('.loading').fadeOut("slow");
                    return false;
