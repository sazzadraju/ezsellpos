...
class Audience extends MX_Controller
{
    ...
    public function index()
    {
        ...
        $this->breadcrumb->add(lang('audience_list'), '', 0);
        $data['breadcrumb'] = $this->breadcrumb->output();
        $row = $this->audience_model->all_audience_list($data);
        ...
        $this->template->load('main', 'audience/index', $data);
    }
