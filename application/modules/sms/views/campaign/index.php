			...
			<div class="col-lg-12">
				<div class="element-wrapper">
					...
					<div class="element-box full-box">
						<div class="row">
                            <div class="col-md-12">
                                <a href="<?php echo base_url();?>sms/campaign/add" class="btn btn-primary btn-rounded right" type="button"><?= lang('add')?></a>
                            </div>
                        </div>
						<div class="row">
							<div class="col-md-12">
								<div class="table-responsive" id="postList">
									<?php $this->load->view('campaign/all_list_data');?>
								</div>
							</div>
						</div>
					</div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="element-header margin-0"><?= lang("campaign_details"); ?> <span
...
<script type="text/javascript">
    ...
    function viewDetaitls(id) {
        //alert(id);
        $.ajax({
            url: "<?php echo base_url() ?>sms/campaign/show_details/" + id,
            type: "GET",
            beforeSend: function () {
                $('.loading').show();
            },
