...
<script type="text/javascript">
	function searchFilter(page_num) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url(); ?>stock/stock_out_pagination_data/' + page_num,
			...
			<div class="col-lg-12">
				<div class="element-wrapper">
					...
					<div class="element-box full-box">
						<div class="row">
                            <div class="col-md-12">
                                <a href="<?php echo base_url();?>product_stock_out" class="btn btn-primary btn-rounded right" type="button"><i class="fa fa-plus"></i> <?= lang('stock_out')?></a>
                            </div>
                        </div>
						<div class="row">
							<div class="col-md-12">
								<div class="table-responsive" id="postList">
									<?php $this->load->view('stock_out/stock_out_list_pagination');?>
								</div>
							</div>
						</div>
					</div>
