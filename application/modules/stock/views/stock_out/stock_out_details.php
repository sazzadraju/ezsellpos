                        ...
                        <div class="col-sm-12">
                            <?php echo $store_name[0]['store_name']; ?>
								...
								<div class="col-md-3">
									<div class="form-group row">
										<label class="col-sm-12 col-form-label"
											   for=""><?= lang('stock_out_reason') ?> </label>
										<div class="col-sm-12">
									...
									<div class="form-group row">
										...
										<div class="col-sm-12">
											...
											if (!empty($doc_list['file'])) {
												?>
												<a href="<?php echo documentLink('stock') . $doc_list['file']; ?>"
												   download>
							...
							<div class="row">
								<div class="col-md-12">
									<div class="table-responsive" id="postList">
										<?php $this->load->view('stock_out/stock_out_details_list')?>
									</div>
								</div>
							</div>
						</div>
...
<script type="text/javascript">
    function stock_print_view(id) {
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url(); ?>stock/stock_out/stock_out_print_view',
            data: 'id=' + id,
            beforeSend: function () {
                $('.loading').show();
            },
