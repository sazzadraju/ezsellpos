<table id="mytable" class="table table-bordred table-striped">
    <thead>
        <tr>
            ...
            <th><?= lang('to_store')?></th>
            <th><?= lang('user')?></th>
            <th><?= lang('stock_transfer_reason')?></th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><a href="<?php echo base_url();?>stock_transfer_send_details/<?php echo $list['id_stock_mvt'];?>"><?php echo $list['invoice_no'];?></a></td>
            ...
            <td>
                ...
                if ($fileExt == '.jpg' || $fileExt == '.png' || $fileExt == '.jpeg' || $fileExt == '.gif') {
                    ...
                    $output .= '<div id="img_' . $list['id_document'] . '" style="display: none;"><img src="' . base_url() . 'public/uploads/stock_documents/' . $name . '" style="width:100%"></div>';
            ...
            <td class="center">
                ...
                if (!empty($list['file'])) {
                    ?>
                    <a href="<?php echo base_url() . 'public/uploads/stock_documents/' . $list['file']; ?>" download><button class="btn btn-success btn-xs"><i class="fa fa-download" aria-hidden="true"></i></button></a> 
                    <?php
                }
                ?>
            </td>
