			...
			<div class="col-lg-12">
				<div class="element-wrapper">
					...
					<div class="element-box full-box">
						<div class="row">
                            <div class="col-md-12">
                                <a href="<?php echo base_url();?>product_stock_transfer" class="btn btn-primary btn-rounded right" type="button"><?= lang('stock_transfer')?></a>
                            </div>
                        </div>
						<div class="row">
							<div class="col-md-12">
								<div class="table-responsive" id="postList">
									<?php $this->load->view('stock_transfer/stock_transfer_list_pagination');?>
								</div>
							</div>
						</div>
					</div>
