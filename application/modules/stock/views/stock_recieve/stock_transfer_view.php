            ...
            <div class="col-lg-12">
                <div class="element-wrapper">
                    <div class="top-btn full-box">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group row">
                                    <label class="col-sm-12 col-form-label"
                                           for=""><?= lang('recieve_invoice') ?> </label>
                                    <div class="col-sm-12">
                            ...
                            <div class="col-md-3">
                                <div class="form-group row">
                                    <label class="col-sm-12 col-form-label"
                                           for=""><?= lang('stock_recieve_date') ?> </label>
                                    <div class="col-sm-12">
                            ...
                            <div class="col-md-3">
                                <div class="form-group row">
                                    <label class="col-sm-12 col-form-label"
                                           for=""><?= lang('stck_recieve_reason') ?> </label>
                                    <div class="col-sm-12">
                    ...
                    <div class="element-box full-box">
                        <div class="row">
                            <div class="col-md-12">
                                <a href="<?php echo base_url(); ?>stock-recieve"
                                   class="btn btn-primary btn-rounded right"
                                   type="button"><?= lang('stock_recieve_list') ?></a>&nbsp;&nbsp;
                                <button style="margin-right: 5px;" class="btn btn-primary pull-right" type="button"
                                        onclick="stock_print_view(<?= $stock_mvt_id ?>)"><i
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="table-responsive" id="postList">
                                    <?php $this->load->view('stock_recieve/stock_transfer_view_list')?>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    function stock_print_view(id) {
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url(); ?>stock/stock_recieve/stock_receive_print_view',
            data: 'id=' + id,
            beforeSend: function () {
                $('.loading').show();
            },
