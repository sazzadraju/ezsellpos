			...
			<div class="col-lg-12">
				<div class="element-wrapper">
					...
					<div class="element-box full-box">
						<div class="row">
                            <div class="col-md-12">
                                <a href="<?php echo base_url();?>product_stock_in" class="btn btn-primary btn-rounded right" type="button"><?= lang('add_stock')?></a>
                            </div>
                        </div>
						<div class="row">
							<div class="col-md-12">
								<div class="table-responsive" id="postList">
									<?php $this->load->view('stock_in/stock_in_list_pagination');?>
								</div>
							</div>
						</div>
					</div>
