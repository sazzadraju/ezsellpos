        ...
        <div class="invoice-body">
            <div class="invoice-table">
                <table class="table">
                        ...
                        foreach ($products as $row) {
                            ...
                            <tr>
                                ...
                                <td class="text-center"
                                    style="width: 15%"><?php echo $row['selling_price_est'] / $row['qty']; ?></td>
                                <td class="text-center" style="width: 15%"><?php echo $row['qty']; ?></td>
                                <td class="text-center" style="width: 15%"><?php echo $row['discount_amt']; ?></td>
                                <td class="text-center" style="width: 15%"><?php echo $row['vat_amt']; ?></td>
                                <td style="text-align: right;width: 15%"><?php echo $row['selling_price_act']; ?></td>
                            </tr>
                            <?php $i++;
                        }
                    }
                    ?>
                    <tr>
                        <td class="text-right" colspan="<?= (3+$c)?>" style="font-weight: 600;"><?= count($count_pro)?> Items</td>
                        <td class="text-center" style="font-weight: 600;"><?= $qty_sum ?></td><td></td>
                        <td class="text-center" style="font-weight: 600;"><?= $vat ?></td>
                    ...
                    <tr>
                        <td style="border: 0;">
                            ...
                            if (isset($delivery_person))
                            {
                                ...
                                ?>
                                <div><h3><?= lang('delivery_details') ?></h3>
                        ...
                        <td colspan="<?= (6+$c)?>" style="border: 0;padding: 0 !important;">
                            ...
                            <table class="foot-table">
                                ...
                                <tr>
                                    ...
                                    <td class="text-right" style="font-weight: bold;border-bottom: 1px solid #666;"><?php echo $product_amt - $all_dis; ?></td>
                                </tr>
                                <!-- Pay Type-->
                                <?php
                                $all_paid_amt = 0;
